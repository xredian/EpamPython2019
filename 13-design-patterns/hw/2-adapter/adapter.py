...
class Adapter:
    def __init__(self, documents_handler):
        self.documents_handler = documents_handler

    def upload_documents(self, documents):
        documents = [document.replace('xml', 'json') for document in documents]
        return self.documents_handler.upload_documents(documents)

    def get_documents(self, document_ids):
        return self.documents_handler.get_documents(document_ids)
